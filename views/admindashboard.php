...
<html>
    ...
    <body>
        <div class="body-container">
            ...
            <form id="addquizform" method='POST' action='../controllers/controller.php'>
                    <input type="hidden" name="page" value="adminheader">
            ...
            <div class="header">
                <div class="main-header row">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <button type="button" class="btn button-container btn-lg" id="addquizbutton" >
                            Add Quiz
                        </button>
        ...
        background-color: transparent;" id="menu-button">
            ...
            <div class=" jumbotron vertical-center align-middle " style="background-color: #e5e4e2; width: 80%; margin-left: 10%; margin-right: 10%;" id="quizcontainer"></div>
    ...
    <script> 
        ...
        document.addEventListener("DOMContentLoaded", function(){
            ...
            $("#viewquizsubmitbutton").click(function(){
